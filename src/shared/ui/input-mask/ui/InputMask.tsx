  ...
  return (
    <div className="relative w-full md:w-auto">
      ...
      <input
        ...
        className={cn(
          "w-full py-3 pr-3 pl-[38px] rounded-lg outline-none border border-border-gray hover:border-brand-hover focus:hover-common-brand placholder:text-text-gray",
          className,
        )}
      />
    </div>
